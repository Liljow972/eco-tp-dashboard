  ...
  return (
    <div className="space-y-8 animate-fade-in p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition-all duration-300 group hover:-translate-y-1">
          ...
          <div className="mt-4">
            ...
            <p className="text-3xl font-bold text-gray-900 mt-2">{stats.co2Saved} Tonnes</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition-all duration-300 group hover:-translate-y-1">
          <div className="flex justify-between items-start">
            ...
            <span className="flex items-center text-xs font-bold text-blue-600 bg-blue-50 px-2.5 py-1 rounded-full animate-pulse-slow">
              En cours
            </span>
          </div>
          <div className="mt-4">
            <h3 className="text-gray-500 text-sm font-medium uppercase tracking-wider">Projets Actifs</h3>
            <p className="text-3xl font-bold text-gray-900 mt-2">{stats.activeProjects} Chantiers</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition-all duration-300 group hover:-translate-y-1">
          ...
          <div className="mt-4">
            <h3 className="text-gray-500 text-sm font-medium uppercase tracking-wider">Clients / Acteurs</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-lg transition-all duration-300">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">Avancement cumulé vs Budget consommé</p>
            </div>
        ...
        {/* Secondary Chart (Pie) */}
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-lg transition-all duration-300 flex flex-col justify-center">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-lg transition-all duration-300">
          <div className="flex items-center justify-between mb-6">
            ...
            <button className="text-sm text-ecotp-green-600 font-medium hover:text-ecotp-green-700 hover:underline">Voir tout</button>
          </div>
            ...
            <div className="space-y-6">
              {recentProjects.map((proj, i) => (
                <div key={i} className="flex gap-4 items-start group cursor-pointer">
                  <div className={`w-10 h-10 rounded-full flex items-center justify-center shrink-0 transition-transform group-hover:scale-110 ${proj.status === 'completed' ? 'bg-green-50 text-green-600' : 'bg-blue-50 text-blue-600'}`}>
                    <Activity className="w-5 h-5" />
                  </div>
                  <div className="flex-1">
                    <h4 className="text-sm font-semibold text-gray-900 group-hover:text-ecotp-green-700 transition-colors">{proj.name}</h4>
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-lg transition-all duration-300">
          <div className="flex items-center justify-between mb-6">
            ...
            <a href="/avancement" className="text-sm text-ecotp-green-600 hover:text-ecotp-green-700 font-medium flex items-center gap-1 hover:underline">
              Voir tout
