...
export default function CollaborationPage() {
  ...
  const TaskCard = ({ task }: { task: any }) => (
    <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100 mb-3 hover:shadow-md transition-shadow group">
      <div className="flex justify-between items-start mb-2">
        ...
        <div className="relative">
          ...
          <select
            className="text-xs bg-transparent border-none text-gray-400 focus:ring-0 cursor-pointer"
            value={task.status}
